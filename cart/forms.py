...
from auto.models import Profile
from auto.models import ShippingAddress
...
class UserInfoForm(forms.ModelForm):
		...
		class Meta:
			model = Profile
			fields = ('phone', 'address1', 'address2', 'county', 'zipcode', 'country')
...
class ShippingForm(ModelForm):
    class Meta:
        ...
        fields = ('firstname', 'lastname', 'address', 'city', 'county', 'zipcode', 'email', 'phonenumber', 'note')
        ...
        widgets = {
            ...
            'phonenumber': forms.TextInput(attrs={'class':'form-control', 'placeholder':'+254123456789', 'id': 'id_phonenumber'}),
